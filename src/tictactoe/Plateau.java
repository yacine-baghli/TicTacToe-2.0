...
//		str.append("\n");
	...
	public int[] checkBloquageOuVictoire() {
	    // Parcourir les lignes
	    for (int i = 0; i < 3; i++) {
	        if (grille[i][0] + grille[i][1] + grille[i][2] == -2) {
	            for (int j = 0; j < 3; j++) {
	                if (grille[i][j] == 0) {
	                    return new int[]{i, j};
	                }
	            }
	        } else if (grille[i][0] + grille[i][1] + grille[i][2] == 2) {
	            for (int j = 0; j < 3; j++) {
	                if (grille[i][j] == 0) {
	                    return new int[]{i, j};
	                }
	    ...
	    for (int j = 0; j < 3; j++) {
	        if (grille[0][j] + grille[1][j] + grille[2][j] == -2) {
	            for (int i = 0; i < 3; i++) {
	                if (grille[i][j] == 0) {
	                    return new int[]{i, j};
	                }
	            }
	        } else if (grille[0][j] + grille[1][j] + grille[2][j] == 2) {
	            for (int i = 0; i < 3; i++) {
	                if (grille[i][j] == 0) {
	                    return new int[]{i, j};
	                }
	    ...
	    // Parcourir la première diagonale
	    ...
	    } else if (grille[0][0] + grille[1][1] + grille[2][2] == 2) {
	        for (int i = 0; i < 3; i++) {
	            if (grille[i][i] == 0) {
	                return new int[]{i, i};
	            }
	    ...
	    // Parcourir la deuxième diagonale
	    ...
	    } else if (grille[0][2] + grille[1][1] + grille[2][0] == 2) {
	        for (int i = 0; i < 3; i++) {
	            if (grille[i][2 - i] == 0) {
	                return new int[]{i, 2 - i};
	            }
	    ...
	    // Aucun blocage ou opportunité de victoire n'a été trouvé
	    return new int[]{-1,-1};
	}
